...
func goTypeToMFFI(typename string) IDL.MetaFFIType{
	...
	switch typename {
	case "string": return IDL.STRING8
	...
	case "untyped int": return IDL.INT64
	case "uint": return IDL.UINT64
	case "uint8": return IDL.UINT8
	case "uint16": return IDL.UINT16
	case "uint32": return IDL.UINT32
	case "uint64": return IDL.UINT64
	case "float32": return IDL.FLOAT32
	case "float64": return IDL.FLOAT64
	case "bool": return IDL.BOOL
	case "interface{}": return IDL.ANY
