...
require (
	github.com/MetaFFI/lang-plugin-go/api v0.3.0
	github.com/MetaFFI/plugin-sdk v0.3.0
)

require (
	github.com/GreenFuze/go-parser v0.0.0-20240414081507-f3897e769e4c // indirect
	github.com/MetaFFI/lang-plugin-go/compiler v0.3.0 // indirect
	github.com/MetaFFI/lang-plugin-go/go-runtime v0.3.0 // indirect
